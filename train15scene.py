...
parser.add_argument('--save-dir', dest='save_dir',
                    ...
                    default='checkpoints/scenewholenetfinetune/', type=str)
...
def main():
    ...
    # ofpthpath = "/home/data1/ygq/scene/pretrainedweights/resnet50.pth"
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch > 0 and epoch % args.save_every == 0:
            ...
            }, is_best, filename=os.path.join(args.save_dir, 'checkpointweighttrain.th'))

        save_checkpoint({
            'state_dict': model.state_dict(),
            'best_prec1': best_prec1,
        }, is_best, filename=os.path.join(args.save_dir, 'modelweighttrain.th'))
...
def save_checkpoint(state, is_best, filename='checkpoint.pth.tar'):
    ...
    if is_best:
        torch.save(state, "./best/best.pth")
